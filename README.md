...
**Paper:** https://arxiv.org/pdf/2105.09938v3

APPS is a dataset for evaluating model performance on Python programming tasks across three
difficulty levels consisting of 1,000 at introductory, 3,000 at interview, and 1,000 at
competition level. The dataset consists of an additional 5,000 training samples, for a total
of 10,000 total samples. We evaluate on questions from the test split, which consists of
programming problems commonly found in coding interviews.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/apps`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/apps) |
| Group | Coding |
| Total samples | 5,000 |
...
- `huggingface` — `codeparrot/apps` (pinned)
