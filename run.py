#!/usr/bin/env python3
"""Run ONE problem of apps through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one apps problem via TrustedRouter")
